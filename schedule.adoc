...
* Geometry processing, projections, clipping, rasterization, GPUs
...
* Ray marching, signed-distance functions, constructive solid geometry, shadertoy
* *May 3: Project ideas due* 
* *May 6: Project presentations (in Lecture)* 
* *May 6: Project proposals due* 
...
* Potential topics: noise, non-photorealistic rendering, glow, BRDFs, HDR, shadows
* Potential topics: procedural modeling
