...
image as it is computed (and allows you to stop a render). 
If you implement this feature, be sure to point it out 
in the readme! Note that you can display gifs in the readme to show off your 
renderer's behavior!
