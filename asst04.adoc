...
(1,-1,0.5), (-1,-1,0.5), and (0,1,0.5). You are also given a shder, `unlit`, that colors 
...
Your application using the default orthographic projection and camera. 
...
* compute the axis-aligned bounding box for its vertices 
