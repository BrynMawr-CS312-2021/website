...
//== Announcements
//[unstyled]
//* Topic this week: link:#procedural[Procedural modeling]
//* link:project.html[Final project]. Project presentations will be *May 19th, 9:30am-12:30pm*. Projects are due *May 20th*. 
//* All resubmissions due: *May 22 for seniors* and *May 27th for non-seniors*
...
|45% | Final Project
|50% | Assignments
|5% | Math jams and math presentations
|===
