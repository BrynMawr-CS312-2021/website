...
== Announcements
[unstyled]
* Topic this week: link:#particles[Real-time graphics: particle systems]
* *No lecture Thursday, April 22*. Instead, link:https://i3dsymposium.github.io/2021/[join I3D 2021!]
